...
> 8,159 n8n workflow JSONs — email, Slack, CRM, Shopify, social, AI, data, telegram, lead gen. Full MAE bridge integration for AI-driven automation.
...
|---|---|---|
| [Core System](bin/) | `bin/` | All automation scripts for hmz-n8n-workflows — MAE integrated |
